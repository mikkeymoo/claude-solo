...
function loadTokenStats() {
  ...
  return { date: DATE_STR, calls: 0, input_tokens: 0, output_tokens: 0, total_tokens: 0, by_tool: {} };
}
...
rl.on('close', () => {
  ...
  if (!stats.by_tool[tool_name]) {
    stats.by_tool[tool_name] = { calls: 0, input_tokens: 0, output_tokens: 0, total_tokens: 0 };
  }
  ...
  // ── Bash-specific: RTK hints + command log ──────────────────────────────
