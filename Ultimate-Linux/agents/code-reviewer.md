...
memory: project
color: red
tools: Read, Glob, Grep, Bash(git diff*), Bash(git log*), Bash(git show*), Bash(rtk git *), mcp__cclsp__find_definition, mcp__cclsp__find_references, mcp__cclsp__get_diagnostics, mcp__cclsp__get_hover
...
- Use LSP tools (`find_references`, `find_definition`, `get_diagnostics`) before Grep for symbol-based review.
