...
Generate a visual map of the codebase: directory structure, key modules, data flow, and entry points. Use at the start of a session to orient before working in an unfamiliar codebase.
