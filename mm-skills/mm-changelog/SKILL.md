...
# /mm-changelog — Generate Changelog from Commits
...
```bash
python ~/.claude/skills/mm-changelog/changelog_gen.py --preview
```
...
```bash
python ~/.claude/skills/mm-changelog/changelog_gen.py --write
```
...
```bash
python ~/.claude/skills/mm-changelog/changelog_gen.py --since v0.5.0
```
...
```bash
python ~/.claude/skills/mm-changelog/changelog_gen.py [--preview|--write] [--since TAG] [--format markdown|json] [--unreleased-only]
```
