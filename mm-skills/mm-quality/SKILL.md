...
# /mm-quality — Quality & Verification
...
Run before /mm-ship. Mechanical checks, not a code review.
...
If all pass: "✅ Verification passed. Ready to /mm-ship."
If any fail: "🔴 Verification failed." — list what to fix.

## Bundled Script

Run `python skills/mm-quality/complexity_report.py [path]` for code complexity analysis.
...
- [ ] Summary line clearly states "✅ Verification passed. Ready to /mm-ship." OR "🔴 Verification failed." with what must be fixed
...
3. Re-run `/mm-quality --gate` to verify
4. Then run `/mm-ship`
```
