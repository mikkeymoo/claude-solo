---
name: mm-sketch
description: "Rapidly scaffold a working prototype from a description. Use for spikes, experiments, and throwaway code. Faster but less complete than /mm-scaffold."
argument-hint: "[description | --api | --cli | --ui | --script]"
---

# /mm-sketch — Quick Prototype
...
- Add error handling (/mm-fix for bugs)
- Add tests (/mm-tdd for coverage)
- Add validation (/mm-quality --gate for verification)
- Consider architecture (/mm-riper --plan for structure)
```
...
- If generation would require > 50 lines and multiple files, suggest using `/mm-scaffold` instead
