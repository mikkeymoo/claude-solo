...
```
/mm-premortem              # Auto-detect context, choose depth
/mm-premortem quick        # Force quick analysis (plans, PRs)
/mm-premortem deep         # Force deep analysis (before implementation)
/mm-premortem <file>       # Analyze specific plan or code
```
...
/mm-premortem deep thoughts/shared/plans/YYYY-MM-DD-feature.md
...
```
User: /mm-premortem deep thoughts/shared/plans/2026-01-08-api-rate-limiting.md
