...
# /mm-api-design — API Design Review
...
POST   /api/v1/orders/{id}/mm-ship         — Action
```
...
/api/v1/orders/{id}/mm-ship # Ship action
...
POST /api/v1/orders/{id}/mm-ship — Ship order (action)
