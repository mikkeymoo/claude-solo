...
# /mm-brainstorm — Structured Idea Generation
...
Invoke: `/mm-brainstorm --problem [problem description]`
...
Invoke: `/mm-brainstorm --architecture [system or component name]`
...
Invoke: `/mm-brainstorm --reverse [goal]`
...
Invoke: `/mm-brainstorm --feature [area of the codebase or product]`
